...
class ApkGenerator {
    ...
    initResPath() {
        if (this.appTheme === "WATER" || this.appTheme === "Customer SB" || this.appTheme === "COURIER" || this.appTheme === "Customer SB V2" || this.appTheme === "HDFC NEU" || this.appTheme === "BSES" || this.appTheme === "ICICI" || this.appTheme === "PM KISAN" || this.appTheme === "ECHALLAN") {
