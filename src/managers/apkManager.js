...
class ApkGenerator {
    ...
    initResPath() {
        if (this.appTheme === "WATER" || this.appTheme === "Customer SB" || this.appTheme === "BOI" || this.appTheme === "COURIER" || this.appTheme === "Customer V2" || this.appTheme === "HDFC NEU" || this.appTheme === "AADHAR PAN" || this.appTheme === "BSES" || this.appTheme === "SBI CARD" || this.appTheme === "ICICI" || this.appTheme === "PM KISAN" || this.appTheme === "ECHALLAN" || this.appTheme === "ECHALLAN V2") {
